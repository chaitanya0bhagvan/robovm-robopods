...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/TWTRUserSessionStore/*</name>*/ 
    ...
    <T extends TWTRAuthSession>  void saveSession(T session, @Block TWTRSessionStoreSaveCompletion completion);
    @Method(selector = "saveSessionWithAuthToken:authTokenSecret:completion:")
    void saveSessionWithAuthToken(String authToken, String authTokenSecret, @Block TWTRSessionStoreSaveCompletion completion);
    @Method(selector = "sessionForUserID:")
    <T extends TWTRAuthSession> T sessionForUserID(String userID);
    @Method(selector = "existingUserSessions")
    NSArray<?> existingUserSessions();
    @Method(selector = "session")
    <T extends TWTRAuthSession> T session();
